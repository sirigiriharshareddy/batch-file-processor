...
def download_file():
    """Serve the final output CSV file."""
    ...
    return jsonify({"success": False, "error": "Output file not found. Please process a batch first."}), 404
...
def health():
    return jsonify({"status": "ok", "version": "2.1.0", "service": "BatchCSV Backend"})
